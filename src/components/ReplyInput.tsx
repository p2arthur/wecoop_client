  ...
  return (
    <div className="relative md:w-full">
      <textarea
        ...
        className="w-full border-2 align-top text-start break-all whitespace-normal h-32 p-2  z-20 focus:scale-101 focus:border-b-4 border-gray-900 focus:outline-gray-500"
      />
